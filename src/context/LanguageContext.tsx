...
const translations: Record<Language, Translations> = {
  ...
  am: {
    ...
    about_spark_text_1:
      "በታዋቂው ኢትዮጵያዊ አርቲስት ሰለሞን ቦጋሌ እና በቁርጠኛ ባለሙያዎች ትብብር በሰኔ 2007 ዓ.ም (እ.ኤ.አ በሰኔ 2015) የተመሰረተው ኅብረት ለበጎ የኢትዮጵያውያን የበጎ አድራጎት ማኅበር፣ የርኅራኄና የሕብረት ሥራ ተምሳሌት በመሆን የቆመ ድርጅት ነው።",
    about_spark_text_2:
      "ጉዟችን የጀመረው ጥልቅ በሆነ ሰብአዊ ተግባር ነበር—ድርጅቱን የመሰረቱት አርቲስት ሰለሞን ቦጋሌ፣ በኩላሊት እጥበት እና በልብ ሕመም ለሚሰቃዩ ሁለት ታማሚ ኢትዮጵያውያን ሕይወት ማዳን ሲሉ የግል ተሽከርካሪዎቻቸውን በሐራጅ በመሸጥ ጭምር ነበር። ይህ ከልብ የመነጨ ተነሳሽነት፣ በተመሳሳይ ሁኔታ ውስጥ የሚገኙ ወገኖችን ለመደገፍ ቀጣይነት ያለው እና የተቀናጀ ጥረት እንደሚያስፈልግ አመላካች ሆኗል።",
    about_spark_text_3:
      "በዚህም ምክንያት ኅብረት ለበጎ ተወለደ—በጣም ለሚያስፈልጋቸው ወገኖች ጤናን፣ ክብርን እና ተስፋን ለመመለስ የተቋቋመ በኅብረተሰብ የሚመራ ንቅናቄ።",
